...
Adding an schema name
-------------

If you want to override the name generated by baucis for the definitions you can add the
attribute `swaggerName` with the definition name you want the schema to have on the swagger.json.
